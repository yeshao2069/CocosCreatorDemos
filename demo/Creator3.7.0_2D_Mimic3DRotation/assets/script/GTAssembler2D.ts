...
import { _decorator, Assembler, RenderData, UIRenderer } from 'cc';
export default class GTAssembler2D extends Assembler {
// 每个2d渲染单元里的有:
// 4个顶点属性数据
// 6个顶点索引 -> 三角剖分成2个三角形
// 每个顶点属性由5个32位数据组成
...
// /** 更新纹理uv坐标 */
    protected updateUVs(comp: UIRenderer) {
...
// /** 更新pos坐标信息 */
    protected updateVerts(comp: UIRenderer) {
...
// /** 更新渲染数据 */
    protected updateRenderData(comp: UIRenderer) {
