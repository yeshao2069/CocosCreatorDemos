...
import { _decorator, Node, UI, SpriteFrame, StencilManager, gfx, Color, Sprite, BaseRenderData, UIRenderer } from 'cc';
...
export class MTBatcher2D {
    ...
    public hackBatch2d(batcher: UI) {
        ...
        batcher.autoMergeBatches = function(renderComp?: UIRenderer) {
    ...
    public commitComp(comp: UIRenderer, renderData: BaseRenderData | null, frame: SpriteFrame | null, assembler: any, transform: Node | null) {
