	...
	return (function(n) {
		...
		function(t, i, n) {
			...
			var r = n(0),
				...
				h = function(t) {
					var i =
						10 * (1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 1);
					return { x: Math.round(i * t.x) / i, y: Math.round(i * t.y) / i };
				},
				d = function(t) {
					var r = t[0];
				...
				a = function(t) {
					var e = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 0.05,
						u = t.slice(0, 1);
					return (
						t.slice(1).forEach(function(t) {
							var i = u[u.length - 1],
								n = l(t, i);
							if (e < n)
								for (var r = Math.ceil(n / e), o = n / r, s = 0; s < r; s++)
				...
				c = function(t) {
					for (
						var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : 30,
							n = d(t) / (i - 1),
							r = [t[0]],
							o = v(t),
							s = t.slice(1),
							...
							-1 < s[i][n] ||
								(s[i][n] =
									0 === i && 0 === n
										...
										: 0 < i && 0 < n
										? Math.max(
												Math.min(t(i - 1, n), t(i - 1, n - 1), t(i, n - 1)),
												l(r[i], o[n])
										  )
										: 1 / 0),
							s[i][n]
			...
			var u = n(5),
				...
				h = function(t, i, n) {
					return [
						new u(
							'character.' + t + '.strokes',
							e({ opacity: 1, displayPortion: 1 }, i.strokes.length),
							{ duration: n, force: !0 }
						)
					];
				},
				a = function(t, i, n) {
					return [
						new u('character.' + t + '.opacity', 0, { duration: n, force: !0 })
					].concat(h(t, i, 0));
				},
				c = function(t, i, n) {
					var r = i.strokeNum,
					...
					return [
						new u('character.' + t, {
							opacity: 1,
							strokes: s({}, r, { displayPortion: 0, opacity: 1 })
						}),
				...
				f = function(n, t, i, r, o) {
					...
					return (
						(s = s.concat(h(n, t, 0))).push(
							new u(
								'character.' + n,
								{ opacity: 1, strokes: e({ opacity: 0 }, t.strokes.length) },
								{ force: !0 }
							)
						),
				...
				showCharacter: function(t, i, n) {
					return [
						new u(
							...
							{
								opacity: 1,
								strokes: e({ opacity: 1, displayPortion: 1 }, i.strokes.length)
							},
							{ duration: n, force: !0 }
						)
					];
				...
				highlightStroke: function(t, i, n) {
					...
					return [
						...
						new u('character.highlight', {
							opacity: 1,
							strokes: s({}, r, { displayPortion: 0, opacity: 0 })
						}),
						new u(
						...
						new u('character.highlight.strokes.' + r + '.opacity', 0, { duration: o })
					];
				},
				animateCharacter: f,
				...
				animateSingleStroke: function(o, s, t, i) {
					return [
						new u('character.' + o, function(t) {
							for (
								var i = t.character[o], n = { opacity: 1, strokes: {} }, r = 0;
								r < s.strokes.length;
								r++
							)
								n.strokes[r] = { opacity: i.opacity * i.strokes[r].opacity };
							return n;
						})
		...
		function(t, i, n) {
			...
			(h.prototype.run = function(t) {
				...
				(h.prototype.resume = function() {
					null !== this.S &&
						((this.T = e(this.C)), (this.k += s() - this.S), (this.S = null));
				}),
				(h.prototype.M = function(t) {
					if (null === this.S) {
						...
						if (1 === n)
							this.F.updateState(this.O), (this.T = null), this.cancel(this.F);
						else {
		...
		function(t, i, n) {
			...
			function g() {
				if (0 < arguments.length) {
					...
					1 < arguments.length &&
						(i =
							'string' == typeof (arguments.length <= 1 ? void 0 : arguments[1])
								? (console.warn(
			...
			(g.prototype.showCharacter = function() {
					...
					this.G(function() {
						return t.F.run(
							f.showCharacter(
								'main',
								t.V,
								'number' == typeof i.duration ? i.duration : t.B.strokeFadeDuration
							)
						).then(function(t) {
				...
				(g.prototype.animateStroke = function(t) {
					...
					return (
						...
						this.G(function() {
							return i.F.run(
								f.animateSingleStroke('main', i.V, t, i.B.strokeAnimationSpeed)
							).then(function(t) {
				...
				(g.prototype.updateColor = function(o, s) {
					...
					return this.G(function() {
						...
						return (
							'radicalColor' !== o || s || (r = r.concat(f.updateColor(o, null, 0))),
				...
				(g.prototype.N = function(t, i) {
					...
					return (
						...
						(this.target = this.Y.createRenderTarget(t, i.width, i.height)),
						(this.B = this.tt(i)),
						(this.X = new c(this.B)),
						this.it(),
						(this.$ = null),
				...
				(g.prototype.tt = function(t) {
					...
					return (
						t.strokeAnimationDuration &&
							...
							(i.strokeAnimationSpeed = 500 / i.strokeAnimationDuration),
						t.strokeHighlightDuration &&
							!t.strokeHighlightSpeed &&
							(i.strokeHighlightSpeed = 500 / i.strokeHighlightDuration),
						t.highlightCompleteColor || (i.highlightCompleteColor = i.highlightColor),
						this.nt(i)
					);
				}),
				...
				(g.prototype.it = function() {
					...
					this.target.addPointerStartListener(function(t) {
						i.$ && (t.preventDefault(), i.rt('startUserStroke', t.getPoint()));
					}),
						this.target.addPointerMoveListener(function(t) {
							i.$ && (t.preventDefault(), i.rt('continueUserStroke', t.getPoint()));
						}),
			...
			(g.loadCharacterData = function(t) {
				var i = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
					n = void 0;
				return (
					(n = k && m === i ? k : new c(l({}, w, i))), (m = i), (k = n).loadCharData(t)
				);
			}),
			...
			function e(t, i, n) {
				(this.ot = n),
					...
					(this.state = {
						...
						character: {
							main: { opacity: i.showCharacter ? 1 : 0, strokes: {} },
				...
				for (var r = 0; r < t.strokes.length; r++)
					(this.state.character.main.strokes[r] = { opacity: 1, displayPortion: 1 }),
			...
			(e.prototype.updateState = function(t) {
				...
				(e.prototype.run = function(n) {
					...
					return (
						...
						new Promise(function(t) {
							var i = { et: !0, ut: 0, I: t, ht: n, at: o.loop, ct: s };
							r.st.push(i), r.ft(i);
						})
					);
				}),
				...
				o = function(o) {
					return o.strokes.map(function(t, i) {
						...
						return new e(
							...
							r,
							i,
							((n = i), o.radStrokes && 0 <= o.radStrokes.indexOf(n))
						);
					});
				};
		...
		function(t, i, n) {
			...
			(v.prototype.startQuiz = function(t) {
				...
				(v.prototype.startUserStroke = function(t) {
					...
					if (this.gt) return this.endUserStroke();
					var n = u();
					(this.gt = new o(n, i, t)), this.F.run(h.startUserStroke(n, i));
				}),
				(v.prototype.continueUserStroke = function(t) {
					if (this.gt) {
						var i = this.q.convertExternalPoint(t);
						this.gt.appendPoint(i, t);
						var n = this.gt.points.slice(0);
						this.F.run(h.updateUserStroke(this.gt.id, n));
					}
				}),
				(v.prototype.endUserStroke = function() {
					if (this.gt)
						if (
							(this.F.run(h.removeUserStroke(this.gt.id, this.B.drawingFadeDuration)),
							1 !== this.gt.points.length)
						) {
							var t = this.kt(),
								i = 0 < this.F.state.character.outline.opacity;
							r(this.gt, this.V, this.pt, {
								isOutlineVisible: i,
				...
				(v.prototype.mt = function() {
					...
					var t = c.showStroke('main', this.pt, this.B.strokeFadeDuration);
					(this.pt += 1),
						(this.yt = 0),
				...
				p = function(t, i, n) {
					...
					var a,
						...
						M =
							...
							k <= 0.4 * y),
						S = ((m = i), 0.35 <= (o * (A(t) + 25)) / (m.getLength() + 25));
			...
			t.exports = {
				...
				startQuiz: function(t, i) {
					return o
						...
						.concat([
							new r(
								'character.highlight',
								{ opacity: 1, strokes: s({ opacity: 0 }, t.strokes.length) },
								{ force: !0 }
							),
							new r(
								'character.main',
				...
				startUserStroke: function(t, i) {
					return [
						...
						new r('userStrokes.' + t, { points: [i], opacity: 1 }, { force: !0 })
					];
				},
				updateUserStroke: function(t, i) {
					return [new r('userStrokes.' + t + '.points', i, { force: !0 })];
				},
				removeUserStroke: function(t, i) {
					return [
						new r('userStrokes.' + t + '.opacity', 0, { duration: i }),
		...
		function(t, i, n) {
			...
			(s.prototype.mount = function(t) {
				...
				(s.prototype.render = function(r) {
					...
					var s = r.userStrokes || {};
					Object.keys(this.jt).forEach(function(t) {
						s[t] || (o.jt[t].destroy(), delete o.jt[t]);
					}),
						Object.keys(s).forEach(function(t) {
							if (s[t]) {
								var i = u(
									...
									n = o.jt[t];
								n || ((n = new e()).mount(o.Pt), (o.jt[t] = n)), n.render(i);
							}
						});
				}),
				(s.prototype.destroy = function() {
					o.removeElm(this.Pt.svg), (this.Pt.defs.innerHTML = '');
				}),
				(t.exports = s);
		},
		function(t, i, n) {
			...
			function s(t) {
				(this.xt = {}),
					(this.Ot = t.strokes.map(function(t) {
						return new o(t);
					}));
			}
			(s.prototype.mount = function(t) {
				...
				(this.At = n.svg),
					this.Ot.forEach(function(t, i) {
						t.mount(n);
					});
			}),
				(s.prototype.render = function(t) {
					if (t !== this.xt) {
						t.opacity !== this.xt.opacity &&
							((this.At.style.opacity = t.opacity),
							r ||
								(0 === t.opacity
									? (this.At.style.display = 'none')
									: 0 === this.xt.opacity &&
									  this.At.style.removeProperty('display')));
						var i =
							!this.xt ||
							t.strokeColor !== this.xt.strokeColor ||
							t.radicalColor !== this.xt.radicalColor;
						if (i || t.strokes !== this.xt.strokes)
							for (var n = 0; n < this.Ot.length; n++)
								(!i && this.xt.strokes && t.strokes[n] === this.xt.strokes[n]) ||
									this.Ot[n].render({
		...
		function(t, i, n) {
			...
			var r = n(0).counter,
				...
				h = n(6);
			function a(t) {
				(this.xt = {}), (this.L = t), (this.R = t.getLength() + 100);
			}
			((a.prototype = Object.create(h.prototype)).mount = function(t) {
				(this.Ft = e.createElm('path')),
					(this.Dt = e.createElm('clipPath')),
					(this.Tt = e.createElm('path'));
				var i = 'mask-' + r();
				e.attr(this.Dt, 'id', i),
					e.attr(this.Tt, 'd', this.L.path),
					(this.Ft.style.opacity = 0),
					e.attr(this.Ft, 'clip-path', e.urlIdRef(i));
				var n = s(this.L.points, 100);
				return (
					e.attr(this.Ft, 'd', u(n)),
					e.attrs(this.Ft, {
						stroke: '#FFFFFF',
						'stroke-width': 200,
						fill: 'none',
					...
					this.Dt.appendChild(this.Tt),
					t.defs.appendChild(this.Dt),
					t.svg.appendChild(this.Ft),
					this
				);
			}),
				(a.prototype.render = function(t) {
					if (t !== this.xt) {
						t.displayPortion !== this.xt.displayPortion &&
							(this.Ft.style.strokeDashoffset = this.z(t.displayPortion));
						var i = this.H(t);
						if (i !== this.H(this.xt)) {
							var n = i.r,
								r = i.g,
						...
						t.opacity !== this.xt.opacity && (this.Ft.style.opacity = t.opacity),
							(this.xt = t);
					}
				}),
				(t.exports = a);
		...
		function(t, i, n) {
			...
			(r.prototype.mount = function(t) {
				(this.Et = e.createElm('path')), t.svg.appendChild(this.Et);
			}),
				(r.prototype.render = function(t) {
					if (t !== this.xt) {
						if (
							t.strokeColor !== this.xt.strokeColor ||
							t.strokeWidth !== this.xt.strokeWidth
						) {
							var i = t.strokeColor,
								n = i.r,
								r = i.g,
						...
						t.opacity !== this.xt.opacity && e.attr(this.Et, 'opacity', t.opacity),
							t.points !== this.xt.points && e.attr(this.Et, 'd', u(t.points)),
							(this.xt = t);
					}
				}),
			...
			(function(u) {
				...
				function c(t, i) {
					(this.svg = t),
						(this.defs = i),
						(this.node = t),
						this.node.createSVGPoint && (this.It = this.node.createSVGPoint());
				}
				((c.prototype = Object.create(n.prototype)).createSubRenderTarget = function() {
					...
					(c.prototype._ = function(t) {
						if (this.It) {
							(this.It.x = t.clientX), (this.It.y = t.clientY);
							var i = this.It.matrixTransform(this.node.getScreenCTM().inverse());
							return { x: i.x, y: i.y };
						}
					...
					(c.prototype.K = function(t) {
						if (this.It) {
							(this.It.x = t.touches[0].clientX), (this.It.y = t.touches[0].clientY);
							var i = this.It.matrixTransform(this.node.getScreenCTM().inverse());
							return { x: i.x, y: i.y };
						}
					...
					(c.init = function(t) {
						var i =
							...
							r = void 0,
							o = t;
						if (('string' == typeof t && (o = u.document.getElementById(t)), !o))
							throw new Error('HanziWriter target element not found: ' + t);
						var s = o.nodeName.toUpperCase();
						'SVG' === s || 'G' === s ? (r = o) : ((r = h('svg')), o.appendChild(r)),
		...
		function(t, i, n) {
			...
			(o.prototype.mount = function(t) {
				...
				(o.prototype.zt = function(t) {
					var i = this.Wt.getContext();
					i.clearRect(0, 0, this.q.width, this.q.height),
						i.save(),
						i.translate(this.q.xOffset, this.q.height - this.q.yOffset),
			...
			(function(n) {
				...
				function s(t) {
					...
					(this.L = t),
						...
						i && n.Path2D
							? (this.Rt = new n.Path2D(this.L.path))
							: (this.Ht = o(this.L.path)),
						(this.Lt = r(this.L.points, 100));
				}
				((s.prototype = Object.create(i.prototype)).render = function(t, i) {
					if (!(i.opacity < 0.05)) {
						t.save(),
							this.Rt
								? t.clip(this.Rt)
								: (this.Ht(t), (t.globalAlpha = 0), t.stroke(), t.clip());
						var n = this.H(i),
							r = n.r,
							o = n.g,
							s = n.b,
				...
				((e.prototype = Object.create(t.prototype)).getContext = function() {
					...
					(e.init = function(t) {
						var i =
							...
							r = void 0,
							o = t;
						if (('string' == typeof t && (o = s.document.getElementById(t)), !o))
							throw new Error('HanziWriter target element not found: ' + t);
						return (
							'CANVAS' === o.nodeName.toUpperCase()
								? (r = o)
								: ((r = s.document.createElement('canvas')), o.appendChild(r)),
		...
		function(t, i, n) {
			...
			function o(t) {
				(this.Ut = 0), (this.B = t), (this._t = !1), (this.loadingFailed = !1);
			}
			(o.prototype.Kt = function(t, i) {
				var n = this,
					r = function(t) {
						i === n.Ut && n.I(t);
					},
				...
				(o.prototype.Bt = function() {
					var n = this;
					return new Promise(function(t, i) {
						(n.I = t), (n.Nt = i);
					}).then(
						function(t) {
							return (n._t = !1), r(n.B.onLoadCharDataSuccess, t), t;
						},
						function(t) {
							if (
								((n._t = !1),
								...
								var i = new Error('Failed to load char data for ' + n.Gt);
								throw ((i.reason = t), i);
							}
						}
					);
				...
				(o.prototype.loadCharData = function(t) {
					...
					var i = this.Bt();
					return (
						(this.loadingFailed = !1), (this._t = !0), this.Ut++, this.Kt(t, this.Ut), i
					);
				}),
				(t.exports = o);
		}
