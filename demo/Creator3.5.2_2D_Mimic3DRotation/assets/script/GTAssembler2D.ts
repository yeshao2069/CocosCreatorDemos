...
import { _decorator, Assembler, RenderData, UIRenderable } from 'cc';
...
// /** 更新纹理uv坐标 */
    protected updateUVs(comp: UIRenderable) {
...
// /** 更新pos坐标信息 */
    protected updateVerts(comp: UIRenderable) {
...
// /** 更新渲染数据 */
    protected updateRenderData(comp: UIRenderable) {
