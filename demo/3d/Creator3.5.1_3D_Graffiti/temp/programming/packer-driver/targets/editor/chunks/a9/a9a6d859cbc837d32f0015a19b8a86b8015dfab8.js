    ...
    execute: function () {
      ...
      _export("Decal", Decal = (_dec = ccclass('Decal'), _dec2 = property(Camera), _dec3 = property(Material), _dec4 = property(Node), _dec(_class = (_class2 = class Decal extends Component {
        ...
        getTouchPointOnModel(position, normal) {
          ...
          const mo = (_this$meshRenderer = this.meshRenderer) == null ? void 0 : _this$meshRenderer.model;
          ...
          const me = (_this$meshRenderer2 = this.meshRenderer) == null ? void 0 : _this$meshRenderer2.mesh;
          ...
          if (me.renderingSubMeshes.length > 0) {
            const subIdx = s[0];
            const pos = me.renderingSubMeshes[subIdx].geometricInfo.positions; // const pos = me.readAttribute(subIdx, gfx.AttributeName.ATTR_POSITION);
            // if (!pos) { return false; }
        ...
        addDecal(position, normal) {
          ...
          const projectorEye = (_this$mainCamera2 = this.mainCamera) == null ? void 0 : _this$mainCamera2.node.worldPosition;

          if (null == projectorEye) {
            return;
          }

          const me = (_this$meshRenderer3 = this.meshRenderer) == null ? void 0 : _this$meshRenderer3.mesh;
          ...
          const dmr = this.addComponent(_crd && DecalMeshRenderer === void 0 ? (_reportPossibleCrUseOfDecalMeshRenderer({
            error: Error()
          ...
          if (dmr && this.decalMaterial) {
            ...
            newMat.copy(this.decalMaterial); // newMat.setProperty('albedo', new Vec4(Math.random(), Math.random(), Math.random(), 1));

            newMat.setProperty('albedo', new Vec4(0, 0, 0, 1));
            dmr.material = newMat;
          }
        }
        ...
        rotateForVectors(a, b) {
          ...
          const v3 = v.z;
          const h = 1 / (1 + c);
          const vx = new Mat3(0, -v3, v2, v3, 0, -v1, -v2, v1, 0);
...
//# sourceMappingURL=a9a6d859cbc837d32f0015a19b8a86b8015dfab8.js.map