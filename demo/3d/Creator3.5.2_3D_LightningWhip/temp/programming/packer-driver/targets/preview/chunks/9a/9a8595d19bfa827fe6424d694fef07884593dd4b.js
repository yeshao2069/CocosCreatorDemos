System.register(["cc"], function (_export, _context) {
  ...
  return {
    ...
    execute: function () {
      ...
      _cclegacy._RF.push({}, "5bfbf85PTpBSYGYT8Axj1bd", "main", undefined);
      ...
      _export("Lightning", Lightning = (_dec = ccclass("Lignting"), _dec2 = property(), _dec3 = property(), _dec4 = property(), _dec5 = property(Node), _dec6 = property([Node]), _dec(_class = (_class2 = class Lightning extends Component {
        constructor() {
          super(...arguments);
        ...
        update(deltaTime) {
          ...
          var endPos = Vec3.ZERO; // if(this.startNode) {
          ...
          for (var i = 0; i < this.targetNode.length - 1; i++) {
...
//# sourceMappingURL=9a8595d19bfa827fe6424d694fef07884593dd4b.js.map