  ...
  return {
    ...
    execute: function () {
      ...
      _export("game", game = (_dec = ccclass('game'), _dec(_class = class game extends Component {
        ...
        updateState() {
          var boomSrc = find('Main Camera').getComponent(_crd && Bloom === void 0 ? (_reportPossibleCrUseOfBloom({
            error: Error()
          }), Bloom) : Bloom);
...
//# sourceMappingURL=1956ccffd3fe7151f7a5206cdaeb502f1390e67b.js.map