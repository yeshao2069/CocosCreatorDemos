System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _decorator, gfx, pipeline, Material, RenderStage, PipelineStateManager, Camera, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, colors, PPBaseStage;
    ...
    execute: function () {
      ...
      _export("PPBaseStage", PPBaseStage = (_dec = ccclass('PPBaseStage'), _dec2 = property(Material), _dec(_class = (_class2 = class PPBaseStage extends RenderStage {
        ...
        bindShaderParamsVec2(name, value) {
          ...
          var pass = (_this$mat = this.mat) == null ? void 0 : _this$mat.passes[0];
        ...
        setOutputFramebuffer(mgr) {
          ...
          var fb = mgr.createFrameBufferIf(this.outputTexName);
        ...
        bindShaderParamsTexture(mgr, fbName, keyFBName) {
          ...
          var pass = (_this$mat2 = this.mat) == null ? void 0 : _this$mat2.passes[0];

          if (!pass) {
            return;
          }

          var binding = pass.getBinding(fbName);

          if (binding < 0) {
            return;
          }

          var fb = mgr.createFrameBufferIf(keyFBName);

          if (!fb) {
            return;
          }

          var samper = mgr.samper;
        ...
        render(camera) {
          ...
          var pl = this._pipeline;
          var device = pl.device;
          var cmdBuff = pl.commandBuffers[0];
          var fb = this.framebuffer ? this.framebuffer : (_camera$window = camera.window) == null ? void 0 : _camera$window.framebuffer;

          if (null == fb) {
            return;
          }

          var rp = fb.renderPass;
          pl.pipelineUBO.updateCameraUBO(camera);
          var renderArea = new gfx.Rect(0, 0, 1, 1);
          ...
          var shader = this.mat.passes[0].getShaderVariant();
          var inputAssembler = this._ia;
          var pso = null;
...
//# sourceMappingURL=e03945816e6b2f4042e4236f5851739bb8c598aa.js.map