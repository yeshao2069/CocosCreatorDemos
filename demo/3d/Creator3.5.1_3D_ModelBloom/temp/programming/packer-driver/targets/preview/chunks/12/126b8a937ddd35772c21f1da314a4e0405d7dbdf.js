    ...
    execute: function () {
      ...
      _export("PPMgr", PPMgr = (_dec4 = ccclass('PPMgr'), _dec5 = property([PPStageDesc]), _dec4(_class4 = (_class5 = (_class6 = class PPMgr extends Component {
        ...
        generateFrameBuffer(pl) {
          ...
          var width = view.getViewportRect().width;
          var height = view.getViewportRect().height;
          console.log(gfx.SwapchainInfo, gfx.Swapchain);
          ...
          var depthTex = device.createTexture(new gfx.TextureInfo(gfx.TextureType.TEX2D, gfx.TextureUsageBit.DEPTH_STENCIL_ATTACHMENT, gfx.Format.BC1_ALPHA, width, height));
...
//# sourceMappingURL=126b8a937ddd35772c21f1da314a4e0405d7dbdf.js.map