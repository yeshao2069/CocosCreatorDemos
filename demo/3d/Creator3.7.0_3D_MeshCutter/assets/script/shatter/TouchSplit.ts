import { _decorator, Component, Node, Vec2, Vec3, Mat4, systemEvent, SystemEventType, Touch, Camera, geometry, PhysicsSystem, ModelComponent, instantiate, utils, ColliderComponent, BoxColliderComponent, MeshColliderComponent, RigidBodyComponent, MeshRenderer, Mesh, assetManager, resources, Material } from 'cc';
