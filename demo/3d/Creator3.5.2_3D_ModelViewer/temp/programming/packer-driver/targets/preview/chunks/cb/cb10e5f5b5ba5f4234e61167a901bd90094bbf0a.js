System.register(["__unresolved_0", "cc"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Node, Prefab, loader, instantiate, find, Widget, UITransform, view, ResolutionPolicy, resources, screen, UIMgr, _crd, ccclass, property, UILayer;
    ...
    execute: function () {
      ...
      _export("UIMgr", UIMgr = class UIMgr {
        ...
        resize() {
          ...
          var cvs = find('Canvas').getComponent(UITransform); // cvs.node.width = finalW;
        ...
        setup(maxLayers) {
          this.resize();
          var canvas = find('Canvas').getComponent(UITransform);
          ...
          for (var i = 0; i < maxLayers; ++i) {
            ...
            var uiTransfrom = layerNode.addComponent(UITransform);
        ...
        showUI(uiCls, cb, target) {
          ...
          loader.loadResArray(resArr, () => {
            if (ui.prefabUrl) {
              resources.load(ui.prefabUrl, Prefab, (err, prefab) => {
                if (err) return;
...
//# sourceMappingURL=cb10e5f5b5ba5f4234e61167a901bd90094bbf0a.js.map