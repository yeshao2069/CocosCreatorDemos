import { _decorator, Component, Node, Camera, geometry, systemEvent, SystemEventType, EventTouch, Vec3, Prefab, instantiate, RigidBodyComponent, PhysicsSystem, Size, log, PlaneCollider } from 'cc';
...
export class FireByScreenModel extends Component {
    ...
    readonly m_camera: Camera = <any>null;
