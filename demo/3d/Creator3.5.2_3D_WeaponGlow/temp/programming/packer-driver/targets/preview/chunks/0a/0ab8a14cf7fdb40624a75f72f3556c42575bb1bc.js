System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, SkeletalAnimationComponent, SkinningModelComponent, Vec4, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, PlayerCtrl;
    ...
    execute: function () {
      ...
      _export("PlayerCtrl", PlayerCtrl = (_dec = ccclass('PlayerCtrl'), _dec2 = property({
        ...
        constructor() {
          ...
          this._rimColor = new Vec4(0, 0, 0, 0);
        ...
        set rimLightColor(rimColor) {
          ...
          var value = new Vec4(rimColor.x, rimColor.y, rimColor.z, this._rimEnabled ? rimColor.w : 0);
        ...
        set isLoop(v) {
          ...
          var animState = this._anim.getState(this.curAnimName);
        ...
        playAnim(animName, isLoop, cb) {
          var animState = this._anim.getState(animName);
...
//# sourceMappingURL=0ab8a14cf7fdb40624a75f72f3556c42575bb1bc.js.map