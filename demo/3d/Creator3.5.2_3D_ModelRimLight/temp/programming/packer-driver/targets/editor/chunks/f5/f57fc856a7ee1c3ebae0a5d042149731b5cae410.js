  ...
  return {
    ...
    execute: function () {
      ...
      _export("UI_RimLight_HUD", UI_RimLight_HUD = class UI_RimLight_HUD extends (_crd && UIController === void 0 ? (_reportPossibleCrUseOfUIController({
        ...
        constructor() {
          super('prefab/ui_rim_light_hud', (_crd && UILayer === void 0 ? (_reportPossibleCrUseOfUILayer({
            error: Error()
          }), UILayer) : UILayer).HUD);
        ...
        onCreated() {
          ...
          let rimColor = (_crd && PlayerCtrl === void 0 ? (_reportPossibleCrUseOfPlayerCtrl({
            error: Error()
...
//# sourceMappingURL=f57fc856a7ee1c3ebae0a5d042149731b5cae410.js.map