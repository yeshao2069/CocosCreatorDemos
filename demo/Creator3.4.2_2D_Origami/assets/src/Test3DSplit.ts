...
import { _decorator, Component, MeshRenderer, primitives, utils, Vec3, Quat, quat, systemEvent, SystemEventType, EventTouch, Touch, Camera, geometry, Line, mat4, Slider, Input, input } from 'cc';
