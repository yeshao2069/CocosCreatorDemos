import { _decorator, Component, Camera, Sprite, Node, macro, RenderTexture, UITransform, SpriteFrame, tween, Vec3 } from 'cc';
...
export default class ObjectMovingShadow extends Component {
    ...
    onLoad() {
        ...
        this.sp_cameras.forEach((v, i) => {
            ...
            renderTex.initialize({ width: pos.width, height: pos.height });
