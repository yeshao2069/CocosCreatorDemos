System.register(["__unresolved_0", "cc", "__unresolved_1", "__unresolved_2"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Node, Prefab, instantiate, PopupBase, ResPopupItem, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, ResPopup;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", ResPopup = (
      /**
       * 资源展示弹窗
       */
      _dec = ccclass('ResPopup'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Prefab), _dec(_class = (_class2 = class ResPopup extends (_crd && PopupBase === void 0 ? (_reportPossibleCrUseOfPopupBase({
        error: Error()
      }), PopupBase) : PopupBase) {
        constructor() {
          super(...arguments);
        ...
        updateDisplay(options) {
          ...
          for (var i = 0; i < count; i++) {
            ...
            if (optionItems[i] && !existedItems[i]) {
              ...
              var item = node.getComponent(_crd && ResPopupItem === void 0 ? (_reportPossibleCrUseOfResPopupItem({
                error: Error()
              ...
              // 复用组件
              var _item = existedItems[i];

              _item.set(optionItems[i].name, optionItems[i].url);
...
//# sourceMappingURL=2128637ef40e69052ac3328658346a53f6909b2b.js.map