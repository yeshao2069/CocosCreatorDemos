System.register(["cc", "cc/env"], function (_export, _context) {
  ...
  var _cclegacy, _decorator, Component, Node, BlockInputEvents, tween, DEV, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, PopupBase;
      ...
      _export("default", PopupBase = (_dec = ccclass('PopupBase'), _dec2 = property({
        ...
        hide(suspended, duration) {
          ...
          return _asyncToGenerator(function* () {
            ...
            if (duration !== 0) {
              ...
              if (!blocker) {
                blocker = _this2.blocker = new Node('blocker');
        ...
        */
        ...
        playShowAnimation(duration) {
          return new Promise(res => {
            ...
            tween(background).to(duration * 0.5, {
              opacity: 150
            }).start(); // 弹窗主体
        ...
        */
        ...
        playHideAnimation(duration) {
          return new Promise(res => {
            // 背景遮罩
            tween(this.background).delay(duration * 0.5).to(duration * 0.5, {
              opacity: 0
            }).start(); // 弹窗主体

            tween(this.main).to(duration, {
              scale: 0.5,
              opacity: 0
            }, {
              easing: 'backIn'
...
//# sourceMappingURL=463bee226380e6f4e517a16d84061c5422b47dab.js.map