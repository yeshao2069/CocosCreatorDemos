    ...
    execute: function () {
      ...
      _export("MTBatcher2D", MTBatcher2D = class MTBatcher2D {
        ...
        hackBatch2d(batcher) {
          ...
          const mtBatcher = MTBatcher2D.getInstance(); // @ts-ignore
        ...
        static commitComp(comp, data, frame, assembler, transform) {
...
//# sourceMappingURL=15addf19b618a87bfba9db2dfcb8884ec4b4d660.js.map