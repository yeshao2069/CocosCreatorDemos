System.register(["__unresolved_0", "cc", "__unresolved_1"], function (_export, _context) {
  ...
  var _reporterNs, _cclegacy, _decorator, Component, director, Material, MTBatcher2D, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _class3, _crd, ccclass, property, MTTex;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("MTTex", MTTex = (_dec = ccclass('MTTex'), _dec2 = property(Material), _dec3 = property(Material), _dec(_class = (_class2 = (_class3 = class MTTex extends Component {
        constructor(...args) {
          super(...args);

          _initializerDefineProperty(this, "mtMat", _descriptor, this);

          _initializerDefineProperty(this, "defaultMat", _descriptor2, this);
        }
        ...
        loadTextureBindings() {
          ...
          const pass = (_this$mtMat = this.mtMat) == null ? void 0 : _this$mtMat.passes[0];
          const mtTexBindingMap = new Map();
      ...
      }), _descriptor2 = _applyDecoratedDescriptor(_class2.prototype, "defaultMat", [_dec3], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function () {
...
//# sourceMappingURL=3f5ddaf826b77d701b613fbad1083a9ff587eeec.js.map