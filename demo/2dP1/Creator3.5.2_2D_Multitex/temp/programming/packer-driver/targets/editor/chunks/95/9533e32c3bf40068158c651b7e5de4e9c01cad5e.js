    ...
    execute: function () {
      ...
      _export("MTSprite", MTSprite = (_dec = ccclass('MTSprite'), _dec(_class = class MTSprite extends Component {
        ...
        tagAsMTSprite() {
          ...
          const mtTex = (_crd && MTTex === void 0 ? (_reportPossibleCrUseOfMTTex({
            error: Error()
        ...
        tagAsDefaultSprite() {
          ...
          sp._isMTSprite = false;
          sp.customMaterial = mtTex.defaultMat;
        }
...
//# sourceMappingURL=9533e32c3bf40068158c651b7e5de4e9c01cad5e.js.map