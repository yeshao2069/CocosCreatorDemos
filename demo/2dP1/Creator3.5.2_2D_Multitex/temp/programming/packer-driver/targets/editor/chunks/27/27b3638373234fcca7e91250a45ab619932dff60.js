    ...
    execute: function () {
      ...
      _export("MTBatcher2D", MTBatcher2D = class MTBatcher2D {
        ...
        static commitComp(comp, renderData, frame, assembler, transform) {
          ...
          dataHash === 0 || this._currMaterial !== mat || this._currDepthStencilStateStage !== depthStencilStateStage || mtBatcher.curIsMTSprite !== isMTSprite || !mtBatcher.canBatchTexture(texture, textureHash, isMTSprite ? MTBatcher2D.GL_MAX_Texture : 1) || !mtBatcher.canBatchSampler(samp, samplerHash, isMTSprite ? MTBatcher2D.GL_MAX_Texture : 1)) {
...
//# sourceMappingURL=27b3638373234fcca7e91250a45ab619932dff60.js.map