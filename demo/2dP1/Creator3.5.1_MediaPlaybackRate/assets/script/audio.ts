...
import { _decorator, Component, Node, AudioSource, SystemEvent, EventMouse, log, EventKeyboard, KeyCode, Toggle, AssetManager, assetManager, resources, AudioClip, Slider, Label, sys } from 'cc';
