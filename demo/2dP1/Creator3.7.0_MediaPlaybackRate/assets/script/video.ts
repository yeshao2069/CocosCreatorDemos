...
import { _decorator, Component, Node, AudioSource, SystemEvent, EventMouse, log, EventKeyboard, KeyCode, AssetManager, assetManager, resources, AudioClip, Slider, Label, VideoPlayer, sys } from 'cc';
