...
import { _decorator, Component, Node, view, RenderTexture, SpriteFrame, Camera, Sprite, Vec3, GFXColorAttachment, GFXDepthStencilAttachment, UITransform, Slider, Label } from 'cc';
